...
const SLOT_PROMPTS: Record<Slot, string> = {
  office:
    "Editorial fashion photo of a confident man wearing the EXACT garment shown in the reference image as the OUTERMOST visible layer. Keep its color, pattern, fabric, cut, buttons and details identical. The garment must be FULLY VISIBLE from collar to hem — do NOT cover it with a blazer, coat, jacket, scarf or any other layer on top. Style the rest of the outfit (trousers, shoes, accessories) to fit a modern office context. Clean studio or minimal architectural background, soft natural light, full body or 3/4 composition that clearly shows the garment, magazine quality, 4:5 portrait.",
  weekend:
    "Editorial lifestyle photo of a relaxed man wearing the EXACT garment shown in the reference image as the OUTERMOST visible layer. Keep its color, pattern, fabric, cut, buttons and details identical. The garment must be FULLY VISIBLE from collar to hem — do NOT cover it with a jacket, coat, hoodie or any other layer on top. Style the rest of the outfit (trousers/jeans, sneakers, accessories) for a casual weekend. Outdoor café or city street, golden hour daylight, full body or 3/4 composition that clearly shows the garment, magazine quality, 4:5 portrait.",
  evening:
    "Editorial evening photo of an elegant man wearing the EXACT garment shown in the reference image as the OUTERMOST visible layer. Keep its color, pattern, fabric, cut, buttons and details identical. The garment must be FULLY VISIBLE from collar to hem — do NOT cover it with a coat, blazer, scarf or any other layer on top. Style the rest of the outfit (dark trousers, refined shoes, subtle accessories) for a dinner setting. Moody restaurant or bar interior, warm cinematic lighting, full body or 3/4 composition that clearly shows the garment, magazine quality, 4:5 portrait.",
};
